...
npm config set python python3.5 --debug --vs2015 --dry-run-only install --global --production windows-build-tools

npm config set python python3.5 --debug --vcc-build-tools-parameters='' --vs2015 --dry-run-only install --global --production windows-build-tools
